/**
  ******************************************************************************
  * @file    stm32h750b_discovery_lcd.c
  * @author  MCD Application Team
  * @brief   This file includes the driver for Liquid Crystal Display (LCD) module
  *          mounted on STM32H750B-DK board.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32H750B_DK_LCD_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32H750B_DK_LCD_Private_TypesDefinitions Private TypesDefinitions
  * @{
  */
...
/** @defgroup STM32H750B_DK_LCD_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H750B_DK_LCD_Private_FunctionPrototypes Private FunctionPrototypes
  * @{
  */
...
/** @defgroup STM32H750B_DK_LCD_Private_Macros  Private Macros
  * @{
  */
...
/** @defgroup STM32H750B_DK_LCD_Exported_Functions  Exported Functions
  * @{
  */
/**
